...
namespace ECommerce.DAL.Migrations
{
    ...
    [Migration("20220623111328_paymenttype")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.DAL.Entity.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.DAL.Entity.ProductPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce.DAL.External.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ECommerce.DAL.Entity.ProductPayment", b =>
                {
                    b.HasOne("ECommerce.DAL.Entity.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.DAL.Entity.Product", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerce.DAL.External.ApplicationUser", null)
                        .WithMany()
